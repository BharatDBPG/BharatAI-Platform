...
WEBUI_NAME = os.getenv('WEBUI_NAME', 'Bharat AI Platform')
# if WEBUI_NAME != 'Bharat AI Platform':
#     WEBUI_NAME += ' (Bharat AI Platform)'
...
# Security: disable dynamic plugin/tool exec() loading in production
ENABLE_RISK_TOOL_EXEC = os.getenv('ENABLE_RISK_TOOL_EXEC', 'False').lower() == 'true'
